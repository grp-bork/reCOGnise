...
process recognise_genome {
	...
	recognise --marker_set ${params.recognise.marker_set} --genome genome_file --cpus ${task.cpus} --with_sentinels -o recognise/${genome_id} ${genome_id} \$(readlink ${marker_genes_db})/recognise_marker_genes
